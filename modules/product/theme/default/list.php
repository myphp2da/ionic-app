...
<section class="panel">
	...
	<ul class="teamActivity cf" id="teamActivity">
    	<li class="loadMore"><a href="javascript:void(0);" class="ajaxButton loadMore firstLoad" data-lib="dataTable" data-url="product/load/all?sort=latest" data-container="#teamActivity" data-action="add">Load More</a></li>
  	</ul></div>
</section> 		  