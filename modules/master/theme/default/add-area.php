...
$cities = $master_obj->getMasters("1", 'city');
	...
	<div class="panel-body">
		<div class="form">
			<form id="master_form" name="master_form" method="post" class="cmxform form-horizontal tasi-form" action="<?php _e(SITE_URL); ?>master/manager/do" enctype="multipart/form-data">
				...
				<div class="form-group"><label for="pname" class="control-label col-lg-2"><?php _e($name);?> Name:</label>
				...
				if ($cities != 404 ) {
					...
					<div class="form-group">
						<label for="parent" class="control-label col-lg-2">City:</label>
						...
						<div class="col-lg-6">
							<select name="parent" id="parent" class="form-control required">
								...
								foreach ($cities as $city) {
									?>
									<option
										value="<?php _e($city['id']); ?>"<?php if (@$master_details['idCity'] == $city['id']) { ?> selected="selected"<?php } ?>><?php _e($city['strCity']); ?></option>
									<?php
								}
								?>
							</select>
