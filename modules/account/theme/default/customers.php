...
<div class="panel-body">
	...
	<div class="cf" id="customerList">
	    <span class="loadMore"><a href="javascript:void(0);" class="ajaxButton loadMore firstLoad" data-lib="dataTable" data-url="account/load/customers" data-container="#customerList" data-action="add">Load More</a></span>
    </div>